...
class Course(models.Model):
    ...
    teacher = models.ForeignKey(Teacher, null=True, blank=True, verbose_name="讲师", max_length=10)
    youneed_konw = models.CharField(default="", max_length=300, verbose_name='课程须知')
    teacher_tell = models.CharField(default="", max_length=300, verbose_name='讲师提示')
